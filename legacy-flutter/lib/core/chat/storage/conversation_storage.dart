...
/// Optimized ConversationStorage using TypeAdapter for better performance
class ConversationStorage extends HiveTypeAdapterStorage<Conversation> {
  ...
  @override
  Future<List<Conversation>> getItemsAsync() async {
    final sessions = await super.getItemsAsync();
    // Loại bỏ các session trống để không trả về/hiển thị
    sessions.removeWhere((s) => s.messages.isEmpty);
    // Sort by updated at descending
    sessions.sort((a, b) => b.updatedAt.compareTo(a.updatedAt));
